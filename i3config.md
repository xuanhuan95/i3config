...
exec pycharm
exec robo3t
exec_always feh --bg-scale ~/Documents/wallpaper/bg.jpg

#lock computer
bindsym $mod+l exec i3lock
bindsym $mod+Shift+m exec "amixer -q set Master 2dB+ unmute"
bindsym $mod+Shift+n exec "amixer -q set Master 2dB- unmute"
#print screen
